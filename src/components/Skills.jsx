...
const SkillCard = React.memo(({ category, index }) => {
  ...
  return (
    ...
    >
      <Card className="bg-white/3 border border-white/8 backdrop-blur-xl shadow-[0_15px_40px_rgba(8,8,20,0.4)] hover:shadow-[0_20px_50px_rgba(10,10,30,0.55)] transition-all duration-300 group">
